...
Below are sample screens from the Baking Mellow web app.  
*(Note: Ensure these images exist in a `screenshots/` folder in your repository root for them to display correctly.)*
...
3. Open **phpMyAdmin** and import `demo_db.sql`.
4. Update `db.php` if your database credentials are different.
5. Run the project by visiting `http://localhost/baking-mellow/home.html`.
